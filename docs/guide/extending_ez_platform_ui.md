...
Menus in eZ Platform are based on the [KnpMenuBundle](https://github.com/KnpLabs/KnpMenuBundle) and are easily extendable.
...
Menus are extendable using event subscribers/listeners. You can hook into the following events:
...
#### Add new menu item under "Content" with custom attributes
...
#### Add top level menu item with a child
...
#### Add item depending on condition
...
#### Top level menu item with URL redirection
